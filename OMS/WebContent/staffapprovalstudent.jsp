...
<%
    ...
    String staffUsername = (String) session.getAttribute("username");  // Staff's username from session
    ...
    if (staffUsername == null || requestId == null || !role.equals("staff")) {
        response.sendRedirect("sign.html"); // Redirect to login page if not logged in or invalid request
        return;
    }
    ...
    String updateSQL = "UPDATE student_leave_requests SET approval_status = 'Granted', granted_by = ? WHERE id = ?";
    ...
    try {
        ...
        stmt.setString(1, staffUsername); // Staff username

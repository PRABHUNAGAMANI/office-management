...
<head>
    ...
    <title>STAFF ATTENDANCE PANEL</title>
...
<section class="dashboard">
    ...
    <button type="button" class="btn" onclick="window.location.href='staffhome.jsp'">Click</button>
                ...
                <div class="box box3">
                   <i class="uil uil-calendar-alt"></i>
                    <span class="text"> STAFF ATTENDANCE REPORT</span>
                    <button type="submit" class="btn" onclick="window.location.href='staffviewattendance.jsp'">Click</button>
                </div>
            </div>
   ...
   <div class="dropdown-container">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="staffviewattendance.jsp">Staff Attendance Report</a>
        </div>
    </div>
</div>

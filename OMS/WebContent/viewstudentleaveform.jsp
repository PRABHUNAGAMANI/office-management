...
<%
    ...
    try {
        ...
        ps = con.prepareStatement("SELECT * FROM student_leave_requests WHERE username = ?");
...
<section class="dashboard">
    ...
    <div class="dash-content">
        <div class="overview">
            <div class="title">
                ...
                <span class="text"><%= role.toUpperCase() + " LEAVE REPORT" %></span>
            </div>
 ...
 <div class="box box2">
    ...
    <button type="button" class="btn" onclick="redirectToHomePage()">Click</button>
      ...
      <h2><%= username.toUpperCase() %> LEAVE REPORT</h2>
    ...
    <table>
        <thead>
            ...
            <th>GRANTED BY <br> STAFF NAME</th>
            </tr>
        </thead>
        <tbody>
            <%

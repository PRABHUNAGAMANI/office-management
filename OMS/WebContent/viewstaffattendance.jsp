...
<%
    ...
    try {
        ...
        ps = con.prepareStatement("SELECT * FROM studentattendance WHERE role='staff'");
      /*   ps.setString(1, username);  */
        ...
        // Get search query from request
           ...
           String sql = "SELECT * FROM studentattendance WHERE role='staff'";  // Default query
...
<div class="search-box">
     ...
     <div class="dash-content">
        <div class="overview">
             <div class="title">
                ...
                <span class="text">STAFF AATENDANCE REPORT</span>
            </div> 
    ...
    <button type="button" class="btn" onclick="window.location.href='studenthome.jsp'">Click</button>
      ...
      <h2>ALL STAFF ATTENDANCE REPORT</h2>

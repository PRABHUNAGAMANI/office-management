...
<%
    ...
    String sql = "INSERT INTO student_leave_requests (username, start_date, end_date, reason, leave_days, approval_status) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    if ("POST".equalsIgnoreCase(request.getMethod()) && startDate != null && endDate != null && reason != null && leaveDays != null) {
        try {
            ...
            if (rowsAffected > 0) {
                ...
                out.println("<script>alert('Leave request successfully submitted!'); window.location.href='viewstudentleaveform.jsp';</script>");
            } else {

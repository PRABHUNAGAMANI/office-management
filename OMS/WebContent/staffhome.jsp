...
<head>
    ...
    <title>STAFF DASHBOARD PANEL</title>
</head>
<body>
        ...
        <ul class="nav-links">
           <!--  <li><a href="#">
            ...
            <li><a href="#">
              ...
              <li><a href="staffviewsyllabus.jsp">
              <i class="uil uil-graduation-cap"></i>
                <span class="link-name"> SYLLABUS DETAILS </span>
            </a></li>
             <li><a href="staffviewsyllabusreason.jsp">
                 <i class="uil uil-file-alt"></i>
    ...
    <button type="button" class="btn" onclick="window.location.href='attendance.jsp'">Click</button>
                ...
                <div class="box box3">
                   <i class="uil uil-calendar-alt"></i>
                    ...
                    <button type="submit" class="btn" onclick="window.location.href='staffleaverequestform.jsp'">Click</button>
                </div>
            </div>
            ...
            <div class="boxes">
                ...
                <div class="box box3">
                  <i class="uil uil-graduation-cap"></i>
                    <span class="text"> STUDENT LEAVE REPORT </span>
                    <button type="submit" class="btn" onclick="window.location.href='staffviewstudentleave.jsp'">Click</button>
                </div>
            </div>
        </div>
    </div>
